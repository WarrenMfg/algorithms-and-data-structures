class PriorityQueue {
  ...
  _canBubble(childIndex, parentIndex) {
    if (!this._values[childIndex] || !this._values[parentIndex]) return false;

    if (this._values[childIndex].priority < this._values[parentIndex].priority) {
      return true;
    } else if (this._values[childIndex].priority === this._values[parentIndex].priority) {
      if (this._values[childIndex].insertionTime < this._values[parentIndex].insertionTime) {
        return true;
      }
    }
    return false;
  ...
  _findLowestPriorityChildIndex(leftIndex, rightIndex) {
    ...
    if (this._values[leftIndex].priority < this._values[rightIndex].priority) {
      return leftIndex;
    } else if (this._values[leftIndex].priority === this._values[rightIndex].priority) {
      if (this._values[leftIndex].insertionTime < this._values[rightIndex].insertionTime) {
        return leftIndex;
      }
    }
    return rightIndex;
  ...
  dequeue() {
    ...
    while (true) {
      ...
      const lowestPriorityChildIndex = this._findLowestPriorityChildIndex(leftIndex, rightIndex);
