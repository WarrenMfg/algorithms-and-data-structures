...
describe('Singly Linked List', () => {
  ...
  describe('Constructors', () => {
    ...
    it('SinglyLinkedList constructor returns a new instance', () => {
      expected = {
        head: null,
        tail: null,
        length: 0
  ...
  describe('Pop', () => {
    ...
    it('Iterates through a list of items and returns the last value', () => {
      pushItems(list);
      expect(list.head.value).to.equal(10);
  ...
  describe('Shift', () => {
    ...
    it('Returns value of a one item list and resets instance to empty list', () => {
      list.push(10);
    ...
    it('Returns value of a multi-item list and reassigns head to next item', () => {
      pushItems(list);
      expect(list.head.value).to.equal(10);
      expect(list.length).to.equal(5);
      expect(list.tail.value).to.equal(50);
